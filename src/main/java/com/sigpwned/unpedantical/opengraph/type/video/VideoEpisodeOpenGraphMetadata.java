...
public class VideoEpisodeOpenGraphMetadata extends OpenGraphMetadata {
  ...
  public VideoEpisodeOpenGraphMetadata(String type, String title, String url, String description,
      ...
      OffsetDateTime releaseDate, List<String> tags, URI series) {
  ...
  public int hashCode() {
    ...
    result = prime * result
        + Objects.hash(actors, directors, duration, releaseDate, series, tags, writers);
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    VideoEpisodeOpenGraphMetadata other = (VideoEpisodeOpenGraphMetadata) obj;
    return Objects.equals(actors, other.actors) && Objects.equals(directors, other.directors)
        && Objects.equals(duration, other.duration)
        && Objects.equals(releaseDate, other.releaseDate) && Objects.equals(series, other.series)
        && Objects.equals(tags, other.tags) && Objects.equals(writers, other.writers);
  }

  @Override
  public String toString() {
    return "VideoEpisodeOpenGraphMetadata [actors=" + actors + ", directors=" + directors
